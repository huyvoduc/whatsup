...
class ActivitiesHistoryTab extends StatefulWidget {
  final double width;

  const ActivitiesHistoryTab({Key key, @required this.width}) : super(key: key);

  @override
  _ActivitiesHistoryTabState createState() => _ActivitiesHistoryTabState();
}

class _ActivitiesHistoryTabState extends State<ActivitiesHistoryTab> {
